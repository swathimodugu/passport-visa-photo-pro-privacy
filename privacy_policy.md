...
The app collects:
- Photos you capture or select from your library
...
All analysis uses Apple's native frameworks:
- Vision Framework for facial detection
- Core Image for photo enhancement
...
**Camera (Required):** Direct capture without automatic saving
